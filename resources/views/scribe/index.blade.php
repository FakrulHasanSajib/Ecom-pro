                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-products">GET api/products</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products--slug-">
                                <a href="#endpoints-GETapi-products--slug-">GET api/products/{slug}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-sliders">
                                <a href="#endpoints-GETapi-sliders">PUBLIC API: ল্যান্ডিং পেজের জন্য একটিভ স্লাইডারগুলো দিবে</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-admin-sliders">ADMIN API: সব স্লাইডার দেখা (List)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-admin-sliders">
                                <a href="#endpoints-POSTapi-admin-sliders">ADMIN API: নতুন স্লাইডার তৈরি করা</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-admin-sliders--id-">
                                <a href="#endpoints-PUTapi-admin-sliders--id-">ADMIN API: স্লাইডার আপডেট করা</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-admin-sliders--id-">
                                <a href="#endpoints-DELETEapi-admin-sliders--id-">ADMIN API: স্লাইডার ডিলিট করা</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products--slug-">GET api/products/{slug}</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="slug"                data-endpoint="GETapi-products--slug-"
               value="17"
               data-component="url">
    <br>
<p>The slug of the product. Example: <code>17</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-sliders">PUBLIC API: ল্যান্ডিং পেজের জন্য একটিভ স্লাইডারগুলো দিবে</h2>
...
<div class="bash-example">
    ...
    "http://localhost/api/payment/success" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/payment/fail" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/payment/cancel" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/invoice/66529e01-d113-3473-8d6f-9e11e09332ea" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/invoice/66529e01-d113-3473-8d6f-9e11e09332ea"
);
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="shipping_charge"                data-endpoint="POSTapi-checkout"
...
<p>Example: <code>11613.31890586</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>tracking_info</code></b>&nbsp;&nbsp;
<small>object</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="tracking_info"                data-endpoint="POSTapi-checkout"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="utm_source"                data-endpoint="POSTapi-checkout"
               value="consequatur"
               data-component="body">
    <br>
<p>FB/Google tracking data (fbp, fbc). Example: <code>consequatur</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/apply-coupon" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"code\": \"consequatur\",
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/wishlist/toggle" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"product_id\": \"consequatur\"
...
<div class="bash-example">
    ...
    --form "review_image=@C:\Users\ahmed\AppData\Local\Temp\phpFEE2.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\ahmed\AppData\Local\Temp\phpFEE2.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --form "total_stock=17"\
    --form "image=@C:\Users\ahmed\AppData\Local\Temp\phpFF12.tmp" </code></pre></div>
...
<p>Example: <code>11613.31890586</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>total_stock</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="total_stock"                data-endpoint="POSTapi-admin-products"
               value="17"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\ahmed\AppData\Local\Temp\phpFF12.tmp</code></p>
        </div>
        </form>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/products/17" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/admin/products/17"
);
...
<p>The ID of the product. Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-admin-sliders">ADMIN API: সব স্লাইডার দেখা (List)</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/admin/sliders" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/admin/sliders"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-admin-sliders">ADMIN API: নতুন স্লাইডার তৈরি করা</h2>
...
<div class="bash-example">
    ...
    --form "serial=17"\
    --form "link=https://www.mueller.com/laborum-eius-est-dolor-dolores-minus-voluptatem"\
    --form "image=@C:\Users\ahmed\AppData\Local\Temp\phpFF23.tmp" </code></pre></div>
...
body.append('serial', '17');
body.append('link', 'https://www.mueller.com/laborum-eius-est-dolor-dolores-minus-voluptatem');
body.append('image', document.querySelector('input[name="image"]').files[0]);
...
<small>file</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\ahmed\AppData\Local\Temp\phpFF23.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="serial"                data-endpoint="POSTapi-admin-sliders"
               value="17"
               data-component="body">
    <br>
<p>Example: <code>17</code></p>
...
<p>Must be a valid URL. Example: <code>https://www.mueller.com/laborum-eius-est-dolor-dolores-minus-voluptatem</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-admin-sliders--id-">ADMIN API: স্লাইডার আপডেট করা</h2>
...
<span id="example-requests-PUTapi-admin-sliders--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/admin/sliders/17" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "title=consequatur"\
    --form "image=@C:\Users\ahmed\AppData\Local\Temp\phpFF34.tmp" </code></pre></div>
...
<span id="example-responses-PUTapi-admin-sliders--id-">
</span>
<span id="execution-results-PUTapi-admin-sliders--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-admin-sliders--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-admin-sliders--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-admin-sliders--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-admin-sliders--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-admin-sliders--id-" data-method="PUT"
      data-path="api/admin/sliders/{id}"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-admin-sliders--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-admin-sliders--id-"
                    onclick="tryItOut('PUTapi-admin-sliders--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-admin-sliders--id-"
                    onclick="cancelTryOut('PUTapi-admin-sliders--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-admin-sliders--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-admin-sliders--id-"
               value="multipart/form-data"
               data-component="header">
    <br>
<p>Example: <code>multipart/form-data</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-admin-sliders--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-admin-sliders--id-"
               value="17"
               data-component="url">
    <br>
<p>The ID of the slider. Example: <code>17</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>image</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="PUTapi-admin-sliders--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\ahmed\AppData\Local\Temp\phpFF34.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>title</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-admin-sliders--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-admin-sliders--id-">ADMIN API: স্লাইডার ডিলিট করা</h2>
