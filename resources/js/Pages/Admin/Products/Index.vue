...
// Controller theke asha products props
    ...
    <AdminLayout>
        <div class="p-6 bg-gray-100 min-h-screen">
            <div class="flex justify-between items-center mb-6">
                ...
                <Link href="/admin/products/create" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow flex items-center gap-2 transition">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        <tr v-for="product in productList" :key="product.id" class="border-b border-gray-200 hover:bg-gray-50 transition">
                            ...
                            <td class="py-3 px-6 text-center">
                                <span class="bg-purple-100 text-purple-600 py-1 px-3 rounded-full text-xs">
                            ...
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center gap-3">
                                    <button class="w-8 h-8 rounded-full bg-yellow-100 text-yellow-600 flex items-center justify-center hover:bg-yellow-200 transition" title="Edit">
                                    ...
                                    <button @click="deleteProduct(product.id)"
                                            class="w-8 h-8 rounded-full bg-red-100 text-red-600 flex items-center justify-center hover:bg-red-200 transition" title="Delete">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                        ...
                        <tr v-if="productList.length === 0">
                            <td colspan="6" class="py-10 text-center text-gray-500">
                                No products found. <Link href="/admin/products/create" class="text-blue-500 underline">Create one?</Link>
                            </td>
                        </tr>
                    </tbody>
                </table>
